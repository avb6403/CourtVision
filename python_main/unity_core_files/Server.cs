...
public class Server : MonoBehaviour {
  ...
  private void UpdateLoop(){
    ...
    if(this.MainCam2 == null)
      this.MainCam2 = GameObject.FindGameObjectWithTag("MainCamera2");
        ...
        if (s.DataAvailable) {
          ...
          if (RecievedString != null){
            ...
            if (selection == 1) {        
                ...
                StartCoroutine(SendCamCapture(clients[c], MainCam2.GetComponent<Camera>(), myFloat[0].ToString(), myFloat[1].ToString()));
            }
            else {
                StartCoroutine(SendCamCapture(clients[c], MainCam.GetComponent<Camera>(), myFloat[0].ToString(), myFloat[1].ToString()));
            }            
  ...
  private void moveCamera(float[] pose){
    GameObject ClientObj1 = GameObject.Find(ObjectName1);
    GameObject ClientObj2 = GameObject.Find(ObjectName2);
    GameObject ClientObj3 = GameObject.Find(ObjectName3);
